...
// hasFullDatasetAccess + queryData together switch the row display from the
// standard 5-row sample to the full dataset with download actions — doctors,
// admins, and data managers aren't subject to the request-access workflow,
// so they get direct full access.
export function DatasetPreview({ preview, hasFullDatasetAccess = false, queryData = null }) {
  return (
